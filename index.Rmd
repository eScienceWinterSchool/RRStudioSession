...
```{r destroyElementList, eval=TRUE, echo=TRUE}
...
link='https://docs.google.com/spreadsheets/d/e/2PACX-1vSalZScSayJZksB0lRCth3EgFEZxTj1ospdC9NWj5OL9OIkSyyEgIHV2pE-3qS_YLHZ1972z_DSOLv9/pub?gid=122814565&single=true&output=csv'
...
```{r}
head(mapWorldAll@data[,c(13:16)])
```

```{r, eval=TRUE}
# data for clustering
dataCluster=mapWorldAll@data[,c(13:16)]
```
